<template>
  <q-page
      ...
      <div class="row ">
        <div class=" wrap justify-start items-start content-start  ">
          <q-card class="shadow-24 q-pl-none form rounded-borders" >
            ...
            <q-card-section
              ...
              <p class="text-primary cursor-pointer" @click="navigateToLogin()">Already have an account?</p>
            </q-card-section>
          </q-card>
        </div>

        <div class="col q-pa-xl q-pa-xl  landing-image text-message-section">

    <div class="q-px-auto q-pb-xl text-center text-white text-h3">
...
import { useQuasar } from 'quasar'
  ...
  function submit(){
    api.post('user',
    {...data.value, password : password.value, avatar : "dfa"})
    .then(response  => {
